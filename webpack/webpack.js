...
function dependencyHandlers() {
  ...
  const dllPath = path.resolve(process.cwd(), dllPlugin.path || 'node_modules/devops-dlls');
   ...
   */
  if (!dllPlugin.dlls) {
    const manifestPath = path.resolve(dllPath, 'devopsDeps.json');
...
function templateContent() {
  ...
  const dllNames = !dllPlugin.dlls ? ['devopsDeps'] : Object.keys(dllPlugin.dlls);
